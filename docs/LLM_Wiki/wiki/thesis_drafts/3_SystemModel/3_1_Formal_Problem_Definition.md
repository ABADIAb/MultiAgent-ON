...
To resolve these vulnerabilities, in this work we formulate the intent-to-configuration lifecycle as a pre-deployment optimization problem that evaluates both linguistic ambiguity and physical transmission feasibility prior to network actuation.
