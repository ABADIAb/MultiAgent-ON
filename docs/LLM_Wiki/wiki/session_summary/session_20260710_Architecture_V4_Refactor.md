...
* Refactorizar el código fuente base (`src/`) desde la arquitectura heredada V3 hacia el nuevo pipeline lineal descrito en [[architecture/archive/Architecture_v4]].
