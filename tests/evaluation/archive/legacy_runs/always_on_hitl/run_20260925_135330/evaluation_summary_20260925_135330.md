...
- **Median End-to-End Latency:** 14.00s (Mean: 31.68s)
...
| | Semantic Agreement (Well-Formed) | $\frac{1}{N_{well}} \sum (1 - d_{sem})$ | $> 0.85$ | **0.410** | ✗ REVIEW |
...
| **Pillar 3: Efficiency & Friction** | End-to-End Latency ($T_{E2E}$) | $\text{Median} \ [\text{Mean}]$ | Contextual | **14.00s** [31.68s] | ✓ MONITORED |
| | Token Footprint per Demand | $\text{Median} \ [\text{Mean}]$ | Monitored | **8,888 tok** [8997.8] | ✓ MONITORED |
| | Total Token Footprint | Cumulative Tokens | Monitored | **179,956 tok** | ✓ MONITORED |
| | Selective HITL Interruptions | Mean $N_{hitl}$ | $0$ (Nom), $1$ (Others) | **1.05** (21 total) | ✓ PASS |
...
| | Selective HITL Precision | $\frac{\vert \text{True Interrupts} \vert}{\vert \text{All Interrupts} \vert}$ | $100\%$ | **75.0%** | ✗ FAIL |
...
| :---: | :--- | :---: | :---: | :---: | :---: | :---: | -: | -: | -: | -: | -: |
| `I_Nominal` | Nominal | 5 | `approve` | 5/5 | 100.0% | 0 | 12.08s | 35.72s | 8232 | 8142 | 100.0% |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: | :---: | -: | -: | :---: | -: | :---: | :---: |
| `intent_nom_01` | `I` | "Establish an optical connection from H..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 7.11s | 7616 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_02` | `I` | "Establish an optical connection from H..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 13.97s | 8304 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_03` | `I` | "Route traffic from Frankfurt to Cologn..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 135.91s | 8724 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_04` | `I` | "Provision an optical channel from Muni..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 9.53s | 7833 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_05` | `I` | "Connect Hannover to Bremen with minimu..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 12.08s | 8232 | 100% | 1.000 | ✓ | `approve` |
