...
- **Mean End-to-End Latency:** 31.68s
...
| **Pillar 3: Efficiency & Friction** | Mean End-to-End Latency ($T_{E2E}$) | $\frac{1}{N} \sum T_{elapsed}$ | Contextual | **31.68s** | ✓ MONITORED |
| | Total Token Footprint | Cumulative Tokens | Monitored | **179,956 tok** (8997.8 tok/intent) | ✓ MONITORED |
...
| :---: | :--- | :---: | :---: | :---: | :---: | -: | -: | -: |
| `I_Nominal` | Nominal | 5 | `approve` | 5/5 | 100.0% | 35.72s | 8142 | 100.0% |
