...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: | :---: | -: | -: | :---: | -: | :---: | :---: |
| `intent_nom_01` | `I` | "Establish an optical connection from H..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 11.85s | 8153 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_02` | `I` | "Establish an optical connection from H..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 14.75s | 8402 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_03` | `I` | "Route traffic from Frankfurt to Cologn..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 135.77s | 8716 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_04` | `I` | "Provision an optical channel from Muni..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 12.61s | 8058 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_05` | `I` | "Connect Hannover to Bremen with minimu..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 10.78s | 8142 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_06` | `I` | "Set up a lightpath from Berlin to Leip..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 8.95s | 7929 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_07` | `I` | "Establish a route from Dortmund to Col..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 8.61s | 8012 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_08` | `I` | "Provision a lightpath from Nuremberg t..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 12.82s | 8278 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_09` | `I` | "Route an optical channel between Karls..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 13.91s | 8192 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_10` | `I` | "Connect Essen to Dusseldorf with minim..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 11.58s | 7907 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_11` | `I` | "Establish an optical path from Stuttga..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 13.81s | 8121 | N/A | 1.000 | ✓ | `approve` |
| `intent_nom_12` | `I` | "Route high-priority traffic from Breme..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 10.97s | 8001 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_13` | `I` | "Provision an optical lightpath between..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 8.58s | 8007 | N/A | 1.000 | ✓ | `approve` |
| `intent_nom_14` | `I` | "Connect Leipzig to Nuremberg with at l..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 13.56s | 8455 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_15` | `I` | "Route traffic from Cologne to Dusseldo..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 10.77s | 8045 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_16` | `I` | "Establish optical service from Hannove..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 9.23s | 8017 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_17` | `I` | "Provision a connection from Munich to ..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 11.75s | 7911 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_18` | `I` | "Route traffic from Dortmund to Hannove..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 16.65s | 8681 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_19` | `I` | "Connect Frankfurt to Nuremberg with at..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 12.83s | 8516 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_20` | `I` | "Establish an optical lightpath from Ul..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 9.09s | 8082 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_21` | `I` | "Provision optical connectivity from No..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 15.17s | 8396 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_22` | `I` | "Route traffic between Berlin and Hanno..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 10.78s | 8149 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_23` | `I` | "Connect Mannheim to Frankfurt with min..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 12.09s | 8376 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_24` | `I` | "Establish a connection from Leipzig to..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 8.64s | 7959 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_25` | `I` | "Route an optical channel from Stuttgar..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 11.83s | 8181 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_26` | `I` | "Provision an optical service between E..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 12.61s | 8346 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_27` | `I` | "Provision a 200G lightpath between Fra..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 13.82s | 8482 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_28` | `I` | "I need a connection from Stuttgart to ..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 14.55s | 8537 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_29` | `I` | "Establish a secure connection from Stu..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 16.90s | 8731 | 100% | 1.000 | ✓ | `approve` |
| `intent_nom_30` | `I` | "Please route traffic from Hannover to ..." | `clarify` | `clarify` | `approve` | ✓ PASS | 1 | 11.85s | 8370 | 100% | 1.000 | ✓ | `approve` |
